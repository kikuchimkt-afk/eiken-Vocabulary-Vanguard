    ...
    questions: [
        {
            ...
            correctAnswer: 4,
            structure: "most of the characters [S] are [V] completely fictitious [C].",
        ...
        },
        {
            ...
            correctAnswer: 4,
            structure: "before they [S] can view [V] classified documents [O].",
        ...
        },
        {
            ...
            correctAnswer: 1,
            structure: "all students [S] had to vacate [V] their rooms [O].",
        ...
        },
        {
            ...
            correctAnswer: 4,
            structure: "he [S] spoils [V] their daughter [O].",
        ...
        },
        {
            ...
            correctAnswer: 3,
            structure: "for disciplinary action [M].",
        ...
        },
        {
            ...
            correctAnswer: 1,
            structure: "A report [S] caused [V] turmoil [O] in the office [M].",
        ...
        },
        {
            ...
            correctAnswer: 3,
            structure: "they [S] celebrated [V] their triumph [O].",
        ...
        },
        {
            ...
            correctAnswer: 2,
            structure: "Please convey [V] my best wishes [O] to your husband [M].",
        ...
        },
        {
            ...
            correctAnswer: 4,
            structure: "where [M] is [V] that terrible odor [S] coming from?",
            explanation: "odor: （特に不快な）臭い",
            translation: {
                literal: "どこから [M] 来ているのか [V] そのひどい臭いは [S]？",
        ...
        },
        {
            ...
            correctAnswer: 1,
            structure: "a densely populated city [C].",
            explanation: "densely populated: 人口密度の高い",
            translation: {
                literal: "密集して人口の多い都市 [C]。",
                natural: "人口密度の高い都市。",
        ...
        },
        {
            ...
            correctAnswer: 4,
            structure: "Pedro [S] has [V] a bizarre way [O].",
            explanation: "bizarre: 奇妙な、風変わりな",
            translation: {
                literal: "ペドロは [S] 持っている [V] 奇妙な方法を [O]。",
                natural: "ペドロは奇妙な食べ方をする。",
        ...
        },
        {
            ...
            correctAnswer: 2,
            structure: "Kevin [S] could not untie [V] the knot [O].",
            explanation: "knot: 結び目",
            translation: {
                literal: "ケビンは [S] 解けなかった [V] 結び目を [O]。",
                natural: "ケビンは結び目を解けなかった。",
        ...
        },
        {
            ...
            correctAnswer: 3,
            structure: "There was [V] a stunned silence [S].",
            explanation: "stunned: 呆然とした、驚いて声も出ない",
            translation: {
                literal: "あった [V] 呆然とした沈黙が [S]。",
                natural: "呆然とした沈黙が流れた。",
        ...
        },
        {
            ...
            correctAnswer: 1,
            structure: "Vikram [S] had to crawl [V] on his hands and knees [M].",
            explanation: "crawl: 這う",
            translation: {
                literal: "ビクラムは [S] 這わなければならなかった [V] 手と膝をついて [M]。",
                natural: "ビクラムは手と膝をついて這わなければならなかった。",
        ...
        },
        {
            ...
            correctAnswer: 4,
            structure: "you [S] gave away [V] the ending [O].",
            explanation: "give away: （秘密などを）漏らす、ネタバレする",
            translation: {
                literal: "あなたが [S] 漏らしたなんて [V] 結末を [O]！",
        ...
        },
        {
            ...
            correctAnswer: 1,
            structure: "to live up to [V] their expectations [O].",
            explanation: "live up to: （期待や要求に）応える、沿う",
            translation: {
                literal: "応えること [V] 彼らの期待に [O]。",
                natural: "彼らの期待に応えること。",
        ...
        },
        {
            ...
            correctAnswer: 3,
            structure: "Deepak [S] sailed through [V] it [O] easily [M].",
        ...
        },
        {
            ...
            correctAnswer: 2,
            structure: "to win over [V] his audience [O].",
            explanation: "win over: （人を）説得する、味方につける、魅了する",
            translation: {
                literal: "味方につけるために [V] 聴衆を [O]。",
                natural: "聴衆を味方につけるために。",
